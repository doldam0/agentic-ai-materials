...
# MultiModalMessage 활용: 이미지 추론

이미지를 Agent에게 전달하여 _시각적 분석_ 수행
...
result = await Console(agent.run_stream(task=MultiModalMessage(
    source="user",
